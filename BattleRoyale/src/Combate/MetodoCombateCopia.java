...
public class MetodoCombateCopia {
    //declaramos los atributos que son necesarios para calcular el critico, los jugadores y el los turnos del combate
    private Personaje jugador1;
    private Personaje jugador2;
    private CalcularDamage calcularDamage=CalcularDamage.getInstanceOf();
    public MetodoCombateCopia(Personaje jugador1,Personaje jugador2){
    ...
    public void Botmove(){
        ...
        damage=calcularDamage.Damage(getJugador2());

...
public abstract class Entidad {
    ...
    //Constructor
    public Entidad(int vida,int vidaMaxima,int atk,int escudo,int escudoMaximo,double crit,double estadisticaHabilidad, String tipo,String nombre,String nombreHabilidad, int mapaX, int mapaY, Mapa mapa){
    ...
    //declaracion de getters y setter de cada uno de los atributos de la clase Entidad
